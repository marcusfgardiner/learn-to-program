...
Take one down and pass it around, #{english_number i} bottles of beer on the wall."
...
puts "Go to the store and buy some more, #{english_number i} bottles of beer on the wall."
